...
def validate_official(args, data_loader, model):
    ...
    if args.only_generate:
        ...
        bleu, rouge_l, meteor, precision, recall, f1, ind_bleu, ind_rouge, offical_rouge_1, offical_rouge_2, offical_rouge_l = \
        ...
        with open(args.pred_file, 'w') as fw:
            for eid, translation in trans_dict.items():
                ...
                # out_dict['rouge1'] = offical_rouge_1
                # out_dict['rouge2'] = offical_rouge_2
                # out_dict['rougel'] = offical_rouge_l
...
def eval_accuracies(hypotheses, references):
    ...
    return bleu * 100, rouge_l * 100, meteor * 100, precision.avg * 100, \
           recall.avg * 100, f1.avg * 100, ind_bleu, ind_rouge, offical_rouge_1 * 100, offical_rouge_2*100, offical_rouge_l*100
